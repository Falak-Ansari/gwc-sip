...
function showScreen0(){
  ...
  fill(0);
  textSize(16);
  text("Follow the journey of a tiny seed as it grows into \na beautiful flower. To move the seed use the arrow \nkeys. Navigate carefully, gathering resources your \nseed needs to grow and avoiding any obstacles \nalong the way.", 200, 150);

  //Create the play button
  startButton = new Sprite(300,300,100,70, 'k');
...
function youWin(){
  ...
  textSize(18);
  textAlign(LEFT);
  text("You blossomed into a beautiful flower.", 25, 75);
  text("Watching a seed grow into a thriving \nplant fills us with hope for the future \nand the possibilities it holds.", 25, 275);
}
